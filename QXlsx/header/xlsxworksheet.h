...
public:
    ...
    bool copyRichString(Document& src,int src_row, int src_column, int dst_row, int dst_column,const RichString &value, const Format &format = Format());
    QList<CellRange> Getmerges();
